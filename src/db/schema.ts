...
export type NewStudyPlanTemplate = typeof studyPlanTemplates.$inferInsert;
...
export type NewGroupStudyRoom = typeof groupStudyRooms.$inferInsert;
...
export type NewSupportKnowledge = typeof supportKnowledge.$inferInsert;
