...
function isCommandAllowed(command: string): { allowed: boolean; binary: string | null; reason?: string } {
...
router.post("/terminal/sessions", (req: Request, res: Response) => {
...
router.get("/terminal/sessions/:id", (req: Request, res: Response) => {
...
router.get("/terminal/files", (req: Request, res: Response) => {
  const { sessionId, path: filePath = "." } = req.query;

  const session = sessionId ? sessions.get(sessionId as string) : null;
  const workspaceId = session?.workspaceId || "default";
  const workspacePath = ensureWorkspace(workspaceId);
...
router.get("/terminal/files/content", (req: Request, res: Response) => {
  const { sessionId, path: filePath } = req.query;
...
router.post("/terminal/files/content", (req: Request, res: Response) => {
...
router.delete("/terminal/sessions/:id", (req: Request, res: Response) => {
