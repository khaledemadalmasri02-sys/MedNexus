...
import {
  generateExplanationsForDeck,
  getProgress,
  getAllProgress,
  hasCardsWithoutExplanations,
  getExplanationStats,
} from "../lib/explanation-manager.js";
 ...
 */
router.post("/generate/:deckId", async (req: Request, res: Response) => {
 ...
 */
router.get("/progress/:deckId", async (req: Request, res: Response) => {
  const deckId = parseInt(req.params.deckId, 10);
