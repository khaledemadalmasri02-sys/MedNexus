 ...
 */
async function generateExplanation(front, back, mode) {
 ...
 */
export async function generateAllExplanations(front, back) {
    const modes = ["full", "revision", "osce", "brief", "mnemonic", "clinical", "testtrap"];
    const results = {
        full: "",
        revision: "",
        osce: "",
 ...
 */
export async function generateExplanationsForCards(cards) {
    const results = [];
