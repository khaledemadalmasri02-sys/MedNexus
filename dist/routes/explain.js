...
const router = Router();
const VALID_MODES = ["full", "revision", "osce", "brief", "mnemonic", "clinical", "testtrap"];
// Generate explanation for a card
router.post("/", validateBody(explainSchema), async (req, res) => {
...
router.post("/full", validateBody(fullExplainSchema), async (req, res) => {
...
router.post("/batch", validateBody(batchExplainSchema), async (req, res) => {
